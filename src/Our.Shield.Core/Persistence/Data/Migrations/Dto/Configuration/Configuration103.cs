...
namespace Our.Shield.Core.Persistence.Data.Migrations.Dto.Configuration
{
    ...
    /// </summary>
    [TableName(nameof(Shield) + nameof(Persistence.Data.Dto.Configuration))]
    ...
    internal class Configuration103
    {
        ...
        /// </summary>
        [NullSetting(NullSetting = NullSettings.NotNull)]
        [ForeignKey(typeof(Environment103), Name = "FK_" + nameof(Shield) + "_" + nameof(Configuration) + "_" + nameof(Persistence.Data.Dto.Environment))]
