namespace Our.Shield.Core.Models
{
    ...
    internal class Job : IJob
    {
        ...
        /// </param>
        /// <returns>
        /// True, if successfully written the config to the database; Otherwise, False
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// True, if successfully written the journal to the database; Otherwise, False
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// Collection of Journals of the desired type
        /// </returns>
        ...
        /// </summary>
        /// <param name="regex">
        /// The Regex use to match for requests
        /// </param>
        /// <param name="beginRequestPriority">
        /// The priority of the begin request watch
        /// </param>
        /// <param name="beginRequest">
        /// The function to call when the Regex matches a request
        /// </param>
        /// <param name="endRequestPriority">
        /// The priority of the end request watch
        /// </param>
        /// <param name="endRequest">
        /// The function to call when the regex matches a request
        /// </param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="regex">
        /// The regex of the corresponding Web Request to remove
        /// </param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="app">
        /// The App of the corresponding Web Requests to remove
        /// </param>
        /// <returns></returns>
