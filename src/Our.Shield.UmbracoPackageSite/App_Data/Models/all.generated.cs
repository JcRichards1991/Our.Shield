...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "c4f3e8efc67fe95a")]
...
#pragma warning restore 0109
	...
	/// <summary>Secure File</summary>
	[PublishedContentModel("secureFile")]
	public partial class SecureFile : PublishedContentModel
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "secureFile";
		public new const PublishedItemType ModelItemType = PublishedItemType.Media;
#pragma warning restore 0109

		public SecureFile(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<SecureFile, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
		...
		///<summary>
		/// Member Only: Only members who have logged in can view this image
		///</summary>
		[ImplementPropertyType("umbracoMemberOnly")]
		public bool UmbracoMemberOnly
		{
			get { return this.GetPropertyValue<bool>("umbracoMemberOnly"); }
		}
	}

	/// <summary>Secure Image</summary>
	[PublishedContentModel("secureImage")]
	public partial class SecureImage : PublishedContentModel
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "secureImage";
		public new const PublishedItemType ModelItemType = PublishedItemType.Media;
#pragma warning restore 0109

		public SecureImage(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<SecureImage, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
	...
	/// <summary>Secure Folder</summary>
	[PublishedContentModel("secureFolder")]
	public partial class SecureFolder : PublishedContentModel
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "secureFolder";
		public new const PublishedItemType ModelItemType = PublishedItemType.Media;
#pragma warning restore 0109

		public SecureFolder(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<SecureFolder, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
		...
		///<summary>
		/// Member Only: Only members who have logged in can view media stored within this folder
		///</summary>
		[ImplementPropertyType("umbracoMemberOnly")]
		public bool UmbracoMemberOnly
		{
